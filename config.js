const CONFIG = {
    ...
    introDesc: `Trào ck đã đến đây
    Nhớ tui chứ gì tui biết mà =))
    Trả lời câu hỏi ii`,
    btnIntro: 'Gét gô',
    title: 'Đi trày phố thoy, mì kay mãi đỉnk',
    desc: 'Phải chăng Ck không bị do đường, trời không mưa thằng ml kia không say là được đi tráy phố ròi ',
    ...
    reply: 'Mai 7h đón em, 2 mình đi ăn đi cháy phốoo',
    mess: 'Anh biết mà xăng đổ đầy bình rồi, :)) mai cháy hết cái Ngãi Giao',
    messDesc: 'Tối mai 7h, anh qua đón đi ăn nhá, đi tráy phố nhá',
